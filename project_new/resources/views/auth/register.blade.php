...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Registreren als student</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                        <input id="email" placeholder="voorbeeld{{ $suffix->emailStudent }}" type="email" pattern=".+{{ $suffix->emailStudent }}" title="Gebruik jouw school email adres om een account aan te maken. ({{ $suffix->emailStudent }})" class="form-control" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" placeholder="wachtwoord bevestigen" type="password" class="form-control" name="password_confirmation" required>
                            </div>
                        </div>
